...
\title{Predicting Poverty using Super Resolution GAN}
...
\author{%
  Alexander P.~Jermann\thanks{Alternate Email: alexander.jermann@gmail.com} \\
  Department of Computer Science\\
  University of Oxford\\
  Oxford, OX1 3PN \\
  \texttt{alexander.jermann@wadham.ox.ac.uk} \\
